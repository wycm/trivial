...
<header class="Hui-header cl"> <a class="Hui-logo l" title="毕业设计管理系统" href="">毕业设计管理系统</a>
	...
	<ul class="Hui-userbar">
		...
		<li id="Hui-msg"> <a onclick="layer_show('消息列表','message/list',500,400);" title="消息"><span class="badge badge-danger">${unReadMsgSize}</span><i class="Hui-iconfont" style="font-size:18px">&#xe68a;</i></a> </li>
		...
		<dl id="menu-article">
			...
			<dd>
				<ul>
					...
					<li><a onclick="layer_show('设置学生选择导师时间','leader/set-student-choose-teacher-time',600,300);">设置学生选择导师时间</a></li>
					<li><a onclick="layer_show('设置导师选择学生时间','leader/set-teacher-choose-student-time',600,300);">设置导师选择学生时间</a></li>
				</ul>
			</dd>
		</dl>
		</c:if>
