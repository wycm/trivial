...
<script type="text/javascript" src="ress/lib/PIE_IE678.js"></script>
<![endif]-->
...
<div class="pd-20">
	<div class="mt-20">
	<form action="issue/del" method="post" id="form-assign-student">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<c:forEach var="issue" items="${issueList}">
			<tr class="text-c">
				<td><input type="checkbox" value="${issue.id}" name="issue_id"></td>
				<td><c:out value="${issue.subject}"></c:out></td>
				<td><c:out value="${issue.introduction}"></c:out></td>
			</tr>
		</c:forEach>
		</tbody>
	</table>
	<div class="row cl">
      <div class="col-12">
        <input id="submit" class="btn btn-primary radius btn-block" type="submit" value="&nbsp;&nbsp;删除&nbsp;&nbsp;">
      </div>
    </div>
	</form>
	</div>
...
$(function(){
	$("#submit").click(function(){
		var checkFlag = false;
		$("input[name='issue_id']").each(function(){
			if($(this).is(":checked")){
				checkFlag = true;
			}
		});
