...
<div class="pd-20">
	<div class="mt-20">
	<form action="notice/del" method="post" id="form-assign-student">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<c:forEach var="notice" items="${noticeList}">
			<tr class="text-c">
				<td><input type="checkbox" value="${notice.id}" name="notice_id"></td>
				<td><c:out value="${notice.id}"></c:out></td>
				<td><c:out value="${notice.subject}"></c:out></td>
				<td><c:out value="${notice.authorUser.name}"></c:out></td>
			</tr>
		</c:forEach>
		</tbody>
	</table>
