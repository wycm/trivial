...
public class UserController {
	...
	public String importTeacherXls(
		...
		try{
			isSucc = userService.importTeacherXls(new File(filePathName));
	...
	public String modifyInfo(User userTmp, HttpServletRequest request,
		...
		if(user.getType() == 8){
			...
			user.setMajor(userTmp.getMajor());
			user.setUserClass(userTmp.getUserClass());
			user.setIntroduction(userTmp.getIntroduction());
